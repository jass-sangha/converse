...
<template>
    ...
    >
        ...
        <span class="flex min-w-0 items-baseline gap-2">
            <span class="truncate text-sm font-bold text-converse-text">{{ person?.name ?? 'Call' }}</span>
            <span class="shrink-0 text-xs font-medium tabular-nums text-converse-textMuted">{{ statusLabel }}</span>
        </span>
        <span
            title="End call"
            ...
            @click.stop="endCall()"
        >
            <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round" style="transform: rotate(135deg)"><path d="M4.5 3.5h3.6l1.6 4-2.2 1.6a12.5 12.5 0 0 0 5.4 5.4l1.6-2.2 4 1.6v3.6a2 2 0 0 1-2.2 2A16.8 16.8 0 0 1 2.5 5.7a2 2 0 0 1 2-2.2Z" /></svg>
        </span>
    </button>
</template>

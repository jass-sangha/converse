...
<template>
    ...
    >
        ...
        <div class="min-w-0 flex-1">
            ...
            <p class="truncate text-[12.5px] text-converse-textMuted">{{ snippet }}</p>
        </div>
        <button
            type="button"
            title="Cancel reply"
    ...
    <div
        v-else
        class="cv-reply-preview flex items-center gap-2 rounded-[14px] px-[11px] py-[7px]"
    ...
    >
        <div class="relative min-w-0 flex-1">
            ...
            <p class="mt-px truncate text-[12.5px] text-converse-textMuted">{{ snippet }}</p>
        </div>

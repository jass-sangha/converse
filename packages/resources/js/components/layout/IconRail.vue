...
<template>
    ...
    >
        ...
        <button
            ...
            :class="isChats ? 'text-converse-accentContrast' : 'text-converse-textMuted hover:bg-converse-sageTint hover:text-converse-sageText'"
            @click="openChats"
        >
        ...
        <button
            ...
            @click="openProfile"
        >
            <div v-if="isProfile" class="absolute inset-0 rounded-full border-[2.5px] border-converse-accent" />

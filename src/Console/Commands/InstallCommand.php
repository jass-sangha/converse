...
class InstallCommand extends Command
{
    ...
    protected $description = 'Publish Converse Chat config, views, and theme in one step.';
    ...
    public function handle(): int
    {
        ...
        $this->newLine();
        $this->info('Converse Chat published. Next steps:');
        $this->line('  1. Configure config/chat.php — chatable_models, table_names, media disk, theme.overrides, etc.');
        $this->line('  2. Drop <x-chat::widget /> into any Blade layout to embed chat, or visit /converse/chat for the full-page UI.');
